...
#pragma acc data copyin(max_cols, penalty, referrence [0:transfer_size])       \
    copy(input_itemsets [0:transfer_size])
  {

#pragma acc parallel loop gang num_gangs(NUM_TEAMS) num_workers(NUM_THREADS)   \
    vector_length(1)
