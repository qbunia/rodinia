...
#pragma acc data copyin(currKnode [0:count], offset [0:count])                 \
    copyin(records [0:records_elem], knodes [0:knodes_elem], keys [0:count])   \
        copy(ans [0:count])
      {
...
#pragma acc data copyin(currKnode [0:count], offset [0:count])                 \
    copyin(start [0:count], end [0:count])                                     \
        copyin(lastKnode [0:count], offset_2 [0:count])                        \
            copy(recstart [0:count], reclength [0:count])                      \
                copyin(knodes [0:knodes_elem])
      {
