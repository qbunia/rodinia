...
extern "C" {
#endif
__device__ char OUT__2__5640__single_iteration__113__kernel___exec_mode = 0;

__global__ void OUT__2__5640__single_iteration__113__kernel__(int *rowp__,int *colp__,double *_dev_result,double *_dev_temp)
{
  typedef int int64_t;
  int _p_r;
  int _p_c;
...
__device__ char OUT__1__5640__single_iteration__33__kernel___exec_mode = 0;

__global__ void OUT__1__5640__single_iteration__33__kernel__(int *rowp__,int *colp__,double *Capp__,double *Rxp__,double *Ryp__,double *Rzp__,double *stepp__,double *deltap__,double *_dev_result,double *_dev_temp,double *_dev_power)
{
  typedef int int64_t;
  int _p_r;
  int _p_c;
