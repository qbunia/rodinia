...
__global__ void OUT__1__5416__single_iteration__32__kernel__(double *amb_tempp__,int *rowp__,int *colp__,double *Capp__,double *Rxp__,double *Ryp__,double *Rzp__,double *stepp__,double *deltap__,double *_dev_result,double *_dev_temp,double *_dev_power)
{
  typedef int int64_t;
  int _p_r;
  int _p_c;
