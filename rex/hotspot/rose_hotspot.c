...
/* Launch CUDA kernel ... */
    ...
    void *__args_base[] = {(void *)(int64_t)amb_temp, (void *)(int64_t)row, (void *)(int64_t)col, (void *)(int64_t)Cap, (void *)(int64_t)Rx, (void *)(int64_t)Ry, (void *)(int64_t)Rz, (void *)(int64_t)step, (void *)(int64_t)delta, result, temp, power};
    void *__args[] = {(void *)(int64_t)amb_temp, (void *)(int64_t)row, (void *)(int64_t)col, (void *)(int64_t)Cap, (void *)(int64_t)Rx, (void *)(int64_t)Ry, (void *)(int64_t)Rz, (void *)(int64_t)step, (void *)(int64_t)delta, result + 0, temp + 0, power + 0};
    ...
    int64_t __arg_types[] = {288, 288, 288, 288, 288, 288, 288, 288, 288, 34, 35, 33};
...
/* Launch CUDA kernel ... */
    ...
    void *__args_base[] = {(void *)(int64_t)row, (void *)(int64_t)col, result, temp};
    void *__args[] = {(void *)(int64_t)row, (void *)(int64_t)col, result + 0, temp + 0};
    int64_t __arg_sizes[] = {((int64_t )(sizeof(int ))), ((int64_t )(sizeof(int ))), ((int64_t )(sizeof(double ) * (row * col))), ((int64_t )(sizeof(double ) * (row * col)))};
    int64_t __arg_types[] = {288, 288, 34, 35};
    int32_t __arg_num = 4;
    __tgt_target_teams(__device_id,__host_ptr,__arg_num,__args_base,__args,__arg_sizes,__arg_types,_num_blocks_,_threads_per_block_);
  }
}
