...
// Rodinia. 2011.12; Lukasz G. Szafaryn; code converted to OpenCL;
//======================================================================================================================================================150
//	DESCRIPTION
//======================================================================================================================================================150
// Description
...
{
          int32_t __arg_num = 6;
          int64_t __arg_types[] = {33, 33, 33, 33, 33, 35};
          int64_t __arg_sizes[] = {((int64_t )(sizeof(struct record ) * records_elem)), ((int64_t )(sizeof(struct knode ) * knodes_elem)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(int ) * count)), ((int64_t )(sizeof(struct record ) * count))};
          void *__args[] = {records + 0, knodes + 0, currKnode + 0, offset + 0, keys + 0, ans + 0};
          void *__args_base[] = {records, knodes, currKnode, offset, keys, ans};
...
{
          int32_t __arg_num = 9;
          int64_t __arg_types[] = {33, 33, 33, 33, 33, 33, 33, 35, 35};
          int64_t __arg_sizes[] = {((int64_t )(sizeof(struct knode ) * knodes_elem)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(long ) * count)), ((int64_t )(sizeof(int ) * count)), ((int64_t )(sizeof(int ) * count)), ((int64_t )(sizeof(int ) * count)), ((int64_t )(sizeof(int ) * count))};
          void *__args[] = {knodes + 0, currKnode + 0, offset + 0, lastKnode + 0, offset_2 + 0, start + 0, end + 0, recstart + 0, reclength + 0};
          void *__args_base[] = {knodes, currKnode, offset, lastKnode, offset_2, start, end, recstart, reclength};
          int64_t __device_id = 0;
          __tgt_target_data_begin(__device_id,__arg_num,__args_base,__args,__arg_sizes,__arg_types);
