#include "rex_kmp.h" 
char OUT__1__5089__main__594__id__ = 0;
struct __tgt_offload_entry OUT__1__5089__main__594__omp_offload_entry__ __attribute__((section("omp_offloading_entries")))  = {((void *)(&OUT__1__5089__main__594__id__)), "OUT__1__5089__main__594__kernel__", 0, 0, 0};
//===============================================================================================================================================================================================================
//===============================================================================================================================================================================================================
//	DEFINE / INCLUDE
//===============================================================================================================================================================================================================
...
//====================================================================================================
  ...
  omp_target_memcpy(public . d_endoRow,public . h_endoRow,public . d_endo_mem,0,0,device_id,host_id);
  ...
  omp_target_memcpy(public . d_endoCol,public . h_endoCol,public . d_endo_mem,0,0,device_id,host_id);
  public . h_tEndoRowLoc = ((int *)(malloc((public . d_endo_mem * public . frames))));
  public . d_tEndoRowLoc = (omp_target_alloc((public . d_endo_mem * public . frames),device_id));
  public . h_tEndoColLoc = ((int *)(malloc((public . d_endo_mem * public . frames))));
  public . d_tEndoColLoc = (omp_target_alloc((public . d_endo_mem * public . frames),device_id));
//====================================================================================================
//	EPI POINTS
//====================================================================================================
  public . epiPoints = 31;
  ...
  omp_target_memcpy(public . d_epiRow,public . h_epiRow,public . d_epi_mem,0,0,device_id,host_id);
  ...
  omp_target_memcpy(public . d_epiCol,public . h_epiCol,public . d_epi_mem,0,0,device_id,host_id);
  public . h_tEpiRowLoc = ((int *)(malloc((public . d_epi_mem * public . frames))));
  public . d_tEpiRowLoc = (omp_target_alloc((public . d_epi_mem * public . frames),device_id));
  public . h_tEpiColLoc = ((int *)(malloc((public . d_epi_mem * public . frames))));
  public . d_tEpiColLoc = (omp_target_alloc((public . d_epi_mem * public . frames),device_id));
//====================================================================================================
//	ALL POINTS
//====================================================================================================
  public . allPoints = 51;
...
//======================================================================================================================================================
  for (i = 0; i < public . allPoints; i++) {
    private[i] . in_partial_sum = (omp_target_alloc(sizeof(float ) * 2 * public . tSize + 1,device_id));
    private[i] . in_sqr_partial_sum = (omp_target_alloc(sizeof(float ) * 2 * public . tSize + 1,device_id));
    private[i] . par_max_val = (omp_target_alloc(sizeof(float ) * (2 * public . tSize + 2 * public . sSize + 1),device_id));
    private[i] . par_max_coo = (omp_target_alloc(sizeof(int ) * (2 * public . tSize + 2 * public . sSize + 1),device_id));
  }
//======================================================================================================================================================
...
//======================================================================================================================================================
  public . d_endoT = (omp_target_alloc((public . in_mod_mem * public . endoPoints),device_id));
  public . d_epiT = (omp_target_alloc((public . in_mod_mem * public . epiPoints),device_id));
//======================================================================================================================================================
...
//====================================================================================================
  ...
  for (i = 0; i < public . allPoints; i++) {
    private[i] . d_in2_sub2_sqr = (omp_target_alloc(public . in2_sub2_sqr_mem,device_id));
  }
//======================================================================================================================================================
//	CUMULATIVE SUM 2
//======================================================================================================================================================
...
// Extract a cropped version of the first frame from the video file
    float *host_frame = get_frame(public . d_frames,public . frame_no,0,0,1);
// pointer to video file
// number of frame that needs to be returned
// cropped?
// scaled?
// converted
    omp_target_memcpy(public . d_frame,host_frame,public . frame_mem,0,0,device_id,host_id);
//====================================================================================================
//	PROCESSING
//====================================================================================================
/* Translated from #pragma omp target data ... */
{
      ...
      int64_t __arg_sizes[] = {((int64_t )(sizeof(public_struct ))), ((int64_t )(sizeof(struct private_struct ) * 51))};
      void *__args[] = {&public, private + 0};
      void *__args_base[] = {&public, private};
...
/* Launch CUDA kernel ... */
        ...
        void *__host_ptr = (void *)(&OUT__1__5089__main__594__id__);
        void *__args_base[] = {&public, private};
        void *__args[] = {&public, private + 0};
        int64_t __arg_sizes[] = {((int64_t )(sizeof(public_struct ))), ((int64_t )(sizeof(struct private_struct ) * 51))};
        int64_t __arg_types[] = {33, 33};
...
//======================================================================================================================================================
  ...
  omp_target_memcpy(public . h_tEndoRowLoc,public . d_tEndoRowLoc,(public . d_endo_mem * public . frames),0,0,host_id,device_id);
  omp_target_memcpy(public . h_tEndoColLoc,public . d_tEndoColLoc,(public . d_endo_mem * public . frames),0,0,host_id,device_id);
  omp_target_memcpy(public . h_tEpiRowLoc,public . d_tEpiRowLoc,(public . d_epi_mem * public . frames),0,0,host_id,device_id);
  omp_target_memcpy(public . h_tEpiColLoc,public . d_tEpiColLoc,(public . d_epi_mem * public . frames),0,0,host_id,device_id);
//==================================================50
//	DUMP DATA TO FILE
//==================================================50
  write_data("result.log",public . frames,frames_processed,public . endoPoints,public . h_tEndoRowLoc,public . h_tEndoColLoc,public . epiPoints,public . h_tEpiRowLoc,public . h_tEpiColLoc);
//======================================================================================================================================================
//	DEALLOCATION
//======================================================================================================================================================
//====================================================================================================
