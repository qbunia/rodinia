...
int main(int argc, char *argv[]) {
  int rows = 0, cols = 0, size_I, size_R, niter = 10, iter, k;
...
#pragma acc data copy(J [0:size_I])                                            \
    copyin(iN [0:rows], iS [0:rows], jW [0:cols], jE [0:cols], dN [0:size_I],  \
...
#pragma acc parallel loop present(J, dN, dS, dW, dE, c, iN, iS, jW,            \
                                  jE) private(i, j, k, Jc, G2, L, num, den,    \
                                              qsqr) num_gangs(NUM_TEAMS)       \
...
#pragma acc parallel loop present(J, c) private(i, j, k, D, cS, cN, cW, cE)    \
